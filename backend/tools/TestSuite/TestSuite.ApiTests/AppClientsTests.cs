...
{
    public sealed class AppClientsTests : IClassFixture<CreatedAppFixture>
    {
        ...
        public AppClientsTests(CreatedAppFixture fixture)
        {
            _ = fixture;
        }
        ...
        public async Task Should_update_client()
        {
            ...
            var clients_2 = await _.Apps.PutClientAsync(_.AppName, client.Id, updateNameRequest);
        ...
        public async Task Should_delete_client()
        {
            ...
            var clients_2 = await _.Apps.DeleteClientAsync(_.AppName, client.Id);
        ...
        private async Task<ClientDto> CreateAsync()
        {
            ...
            var clients = await _.Apps.PostClientAsync(_.AppName, createRequest);
