...
namespace Squidex.Domain.Apps.Entities.Contents.GraphQL
{
    ...
    {
        private static readonly List<IEnrichedAssetItemEntity> EmptyAssets = new List<IEnrichedAssetItemEntity>();
        ...
        public override async Task<IEnrichedAssetItemEntity?> FindAssetAsync(Guid id)
        {
        ...
        public async Task<IReadOnlyList<IEnrichedAssetItemEntity>> GetReferencedAssetsAsync(IJsonValue value)
        {
        ...
        private IDataLoader<Guid, IEnrichedAssetItemEntity> GetAssetsLoader()
        {
            return dataLoaderContextAccessor.Context.GetOrAddBatchLoader<Guid, IEnrichedAssetItemEntity>("Assets",
                async batch =>
                {
