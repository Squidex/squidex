...
namespace Squidex.Areas.Api.Controllers.Assets
{
    ...
    public sealed class AssetFoldersController : ApiController
    {
        ...
        {
            var assetFolders = await assetQuery.QueryFoldersAsync(Context, parentId);
        ...
        [ApiPermission(Permissions.AppAssetsUpdate)]
        [ApiCosts(1)]
        public async Task<IActionResult> PutAssetFolder(string app, Guid id, [FromBody] AnnotateAssetDto request)
        {
