...
public static class WebExtensions
{
    ...
    public static IApplicationBuilder UseSquidexCors(this IApplicationBuilder app)
    {
    ...
    public static IApplicationBuilder UseSquidexCompression(this IApplicationBuilder app)
    {
        var compressionOptions = app.ApplicationServices.GetRequiredService<IOptions<CompressionOptions>>().Value;
