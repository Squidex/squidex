...
namespace Squidex.Domain.Apps.Core {
    ...
    public class FieldDescriptions {
        ...
        ///   Looks up a localized string similar to The current item, if the field is part of an array..
        /// </summary>
        public static string ItemDataField {
            get {
                return ResourceManager.GetString("ItemDataField", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The role of the user within the current app..
        /// </summary>
        public static string UserAppRole {
            get {
                return ResourceManager.GetString("UserAppRole", resourceCulture);
            }
        }
