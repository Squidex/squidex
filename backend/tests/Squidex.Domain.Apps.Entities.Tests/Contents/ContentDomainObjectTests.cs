...
namespace Squidex.Domain.Apps.Entities.Contents
{
    public class ContentDomainObjectTests : HandlerTestBase<ContentState>
    {
        ...
        public ContentDomainObjectTests()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(A<ScriptVars>._, A<string>._, A<ScriptOptions>._))
        ...
        public async Task Create_should_create_events_and_update_data_and_status()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(ScriptContext(data, null, Status.Draft), "<create-script>", A<ScriptOptions>._))
                .MustHaveHappened();
            A.CallTo(() => scriptEngine.ExecuteAsync(A<ScriptVars>._, "<change-script>", A<ScriptOptions>._))
                .MustNotHaveHappened();
        }
        ...
        public async Task Create_should_create_events_and_update_status_when_publishing()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(ScriptContext(data, null, Status.Draft), "<create-script>", A<ScriptOptions>._))
                .MustHaveHappened();
            A.CallTo(() => scriptEngine.ExecuteAsync(ScriptContext(data, null, Status.Published), "<change-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task Update_should_create_events_and_update_data()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(ScriptContext(otherData, data, Status.Draft), "<update-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task Update_should_not_create_event_for_same_data()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(A<ScriptVars>._, "<update-script>", A<ScriptOptions>._))
                .MustNotHaveHappened();
        }
        ...
        public async Task Patch_should_create_events_and_update_data()
        {
            ...
            A.CallTo(() => scriptEngine.TransformAsync(ScriptContext(patched, data, Status.Draft), "<update-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task ChangeStatus_should_create_events_and_update_status_when_published()
        {
            ...
            A.CallTo(() => scriptEngine.ExecuteAsync(ScriptContext(data, null, Status.Published, Status.Draft), "<change-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task ChangeStatus_should_create_events_and_update_status_when_changed()
        {
            ...
            A.CallTo(() => scriptEngine.ExecuteAsync(ScriptContext(data, null, Status.Archived, Status.Draft), "<change-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task ChangeStatus_should_create_events_and_update_status_when_unpublished()
        {
            ...
            A.CallTo(() => scriptEngine.ExecuteAsync(ScriptContext(data, null, Status.Draft, Status.Published), "<change-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
        ...
        public async Task Delete_should_create_events_and_update_deleted_flag()
        {
            ...
            A.CallTo(() => scriptEngine.ExecuteAsync(ScriptContext(data, null, Status.Draft), "<delete-script>", A<ScriptOptions>._))
                .MustHaveHappened();
        }
