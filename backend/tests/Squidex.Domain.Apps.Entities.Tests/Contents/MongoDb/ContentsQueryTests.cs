...
//            var contents = await _.ContentRepository.QueryIdsAsync(_.RandomAppId(), ids, false);
...
//            var contents = await _.ContentRepository.QueryAsync(_.RandomApp(), _.RandomSchema(), status, query, true);
