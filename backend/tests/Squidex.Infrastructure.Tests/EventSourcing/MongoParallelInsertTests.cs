...
public sealed class MongoParallelInsertTests : IClassFixture<MongoEventStoreFixture_Replica>
{
    ...
    public MongoParallelInsertTests(MongoEventStoreFixture_Replica fixture)
    {
        _ = fixture;
