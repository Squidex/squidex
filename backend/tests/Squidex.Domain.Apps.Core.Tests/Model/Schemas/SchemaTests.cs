...
public class SchemaTests
{
    ...
    public void Should_set_list_fields()
    {
        ...
        Assert.Equal(FieldNames.Create("2"), schema_1.FieldsInLists);
        Assert.Equal(FieldNames.Create("2"), schema_2.FieldsInLists);
        Assert.Same(schema_1, schema_2);
    }
    ...
    public void Should_also_set_list_fields_if_reordered()
    {
        ...
        Assert.Equal(FieldNames.Create("2", "1"), schema_1.FieldsInLists);
        Assert.Equal(FieldNames.Create("1", "2"), schema_2.FieldsInLists);
    ...
    public void Should_set_reference_fields()
    {
        ...
        Assert.Equal(FieldNames.Create("2"), schema_1.FieldsInReferences);
        Assert.Equal(FieldNames.Create("2"), schema_2.FieldsInReferences);
        Assert.Same(schema_1, schema_2);
    }
    ...
    public void Should_also_set_reference_fields_if_reordered()
    {
        ...
        Assert.Equal(FieldNames.Create("2", "1"), schema_1.FieldsInReferences);
        Assert.Equal(FieldNames.Create("1", "2"), schema_2.FieldsInReferences);
        Assert.NotSame(schema_1, schema_2);
    }
