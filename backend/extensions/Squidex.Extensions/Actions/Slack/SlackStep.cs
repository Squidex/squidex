...
public sealed class SlackStep : RuleFlowStep<EnrichedEvent>
{
    [AbsoluteUrl]
    [LocalizedRequired]
    ...
    {
        var httpClient = executionContext.Resolve<IHttpClientFactory>().CreateClient("SlackAction");
        ...
        await httpClient.OneWayRequestAsync(request, executionContext.Log, requestJson, ct);
