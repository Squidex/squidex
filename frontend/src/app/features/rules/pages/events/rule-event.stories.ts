...
export default {
    title: 'Rules/RuleEvent',
    component: RuleEventComponent,
    argTypes: {
        enabled: {
            control: 'boolean',
        },
    ...
    render: args => ({
        ...
        template: `
            <table class="table table-items table-fixed" style="width: 800px">
                 <tbody [availableSteps]="availableSteps" [expanded]="expanded" [sqxRuleEvent]="event"></tbody>
            </table>
        `,
    }),
    decorators: [
...
type Story = StoryObj<RuleEventComponent>;
                    ...
                    '1': new FlowExecutionStepStateDto({
                        ...
                        attempts: [
                            new FlowExecutionStepAttemptDto({
                                ...
                                started: now,
                                log: [
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message1' }),
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message2' }),
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message3' }),
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message4' }),
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message5' }),
                                    new FlowExecutionStepLogEntryDto({ timestamp: now, message: 'Message6', dump: 'DUMP' }),
                                ],
                                error: 'Something failed',
                            }),
                            new FlowExecutionStepAttemptDto({
...
export const Actions: Story = {
    args: {
        ...
        event: new RuleEventDto({
            ...
            _links: {
                update: new ResourceLinkDto({ method: 'PUT', href: '/events/1' }),
                cancel: new ResourceLinkDto({ method: 'DELETE', href: '/events/1' }),
            },
        }),
        availableSteps: AVAILABLE_STEPS,
    },
