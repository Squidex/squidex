...
describe('StockPhotoService', () => {
    ...
    it('should make get request to get stock photos', inject([StockPhotoService, HttpTestingController], (stockPhotoService: StockPhotoService, httpMock: HttpTestingController) => {
    ...
    it('should return empty stock photos if get request fails', inject([StockPhotoService, HttpTestingController], (stockPhotoService: StockPhotoService, httpMock: HttpTestingController) => {
        let images: ReadonlyArray<StockPhotoDto>;
