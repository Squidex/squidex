...
import { ChangePlanDto, IChangePlanDto, PlanChangedDto, PlansDto } from '../model';
...
export class PlansService {
    ...
    public putPlan(appName: string, dto: IChangePlanDto, version: VersionOrTag): Observable<Versioned<PlanChangedDto>> {
