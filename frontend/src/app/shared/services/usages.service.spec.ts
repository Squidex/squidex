...
describe('UsagesService', () => {
    ...
    it('should make get request to get calls usages', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
    ...
    it('should make get request to get calls usages for team', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
        let usages: CallsUsageDto;
    ...
    it('should make get request to get storage usages', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
    ...
    it('should make get request to get storage usages for team', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
        let usages: ReadonlyArray<StorageUsagePerDateDto>;
    ...
    it('should make get request to get today storage', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
    ...
    it('should make get request to get today storage for team', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
        let usages: CurrentStorageDto;
    ...
    it('should make get request to get log', inject([UsagesService, HttpTestingController], (usagesService: UsagesService, httpMock: HttpTestingController) => {
        let url: string;
